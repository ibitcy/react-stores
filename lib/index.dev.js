...
var StoreEventManager = /** @class */ (function () {
    ...
    StoreEventManager.prototype.remove = function (id) {
        ...
        (_a = this._hook) === null || _a === void 0 ? void 0 : _a.removeEvent(this.name, id);
    };
    StoreEventManager.prototype.add = function (eventTypes, callback, includeKeys) {
        ...
        (_a = this._hook) === null || _a === void 0 ? void 0 : _a.addEvent(this.name, event.id);
        return event;
    };
...
var Store = /** @class */ (function () {
    function Store(initialState, options, persistenceDriver) {
        ...
        (_c = this._hook) === null || _c === void 0 ? void 0 : _c.attachStore(this, this.name, this.opts, false);
    }
    ...
    Store.prototype.setState = function (_a) {
        ...
        (_b = this._hook) === null || _b === void 0 ? void 0 : _b.updateState(this.name, newState, $actionName);
    };
    Store.prototype.resetState = function () {
        this.setState(__assign(__assign({}, this.deepFreeze(this.initialState)), { $actionName: '@resetState' }));
    };
    Store.prototype.removeStore = function () {
        var _a;
        (_a = this._hook) === null || _a === void 0 ? void 0 : _a.removeStore(this.name);
    };

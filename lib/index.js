...
var StoreComponent = /** @class */ (function (_super) {
    ...
    StoreComponent.prototype.shouldStoreComponentUpdate = function (nextProps, nextState) {
        return immutable_1.Map(nextState).equals(immutable_1.Map(this.state)) || immutable_1.Map(nextProps).equals(immutable_1.Map(this.props));
    };
...
var Store = /** @class */ (function () {
    ...
    Store.prototype.equals = function (p1, p2) {
        return immutable_1.Map(p1).equals(immutable_1.Map(p2));
    };
    Store.prototype.setState = function (newState) {
        ...
        for (var property in newState) {
            if (newState.hasOwnProperty(property) && this.state.hasOwnProperty(property)) {
                if (!this.equals(this.state[property], newState[property])) {
                    this.stateImmutable.set(property, newState[property]);
                    updated = true;
                }
            }
        }
    ...
    Store.prototype.resetState = function () {
        this.state = this.stateImmutable.clear().merge(this.initialStateImmutable).toObject();
        this.update();
    };

...
var StoreEventManager = /** @class */ (function () {
    ...
    Object.defineProperty(StoreEventManager.prototype, "numberOfSubscribers", {
        get: function () {
...
function useStore(options) {
    function pickKeys(state) {
        if (options.keys) {
            var pickedState = {};
            var keys = [].concat(options.keys);
    ...
    var _a = React.useState(pickKeys(options.store.state)), state = _a[0], setState = _a[1];
    React.useEffect(function () {
        var storeEvent = options.store.on(options.eventType || 'update', function (storeState) {

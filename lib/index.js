...
function useStore(options, callback) {
    var _a = React.useState(callback(options.store.state)), state = _a[0], setState = _a[1];
    React.useEffect(function () {
        var storeEvent = options.store.on(options.eventType || StoreEventType.Update, function (storeState) {

...
exports.store = new store_1.Store(initialState, {
    live: true,
});
exports.storePersistent = new store_1.Store(initialState, {
    live: true,
}, new store_1.StorePersistentLocalSrorageDriver('demo'));
exports.storeHistory = new store_1.Store(initialState, {
    live: true,
}, new store_1.StorePersistentLocalSrorageDriver('demoHistory'));
...
var Freezer = __webpack_require__(31);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var complex_1 = __webpack_require__(19);
var counter_1 = __webpack_require__(22);
var counter_events_1 = __webpack_require__(21);
var counter_decorator_1 = __webpack_require__(20);
var persistent_1 = __webpack_require__(24);
var store_1 = __webpack_require__(2);
var store_2 = __webpack_require__(3);
var history_1 = __webpack_require__(23);
var pageStore = new store_2.Store({
    page: 0,
}, {
    live: true,
}, new store_2.StorePersistentLocalSrorageDriver('page'));
    ...
    Container.prototype.render = function () {
        return (React.createElement(React.Fragment, null,
            React.createElement("nav", { className: "main-nav" },
                React.createElement("a", { className: pageStore.state.page === 0 ? 'active' : '', href: "#", onClick: this.handleClick.bind(this, 0) }, "Components"),
                React.createElement("a", { className: pageStore.state.page === 1 ? 'active' : '', href: "#", onClick: this.handleClick.bind(this, 1) }, "Persistent"),
                React.createElement("a", { className: pageStore.state.page === 2 ? 'active' : '', href: "#", onClick: this.handleClick.bind(this, 2) }, "Snapshots")),
            React.createElement("div", { className: "inner" },
                pageStore.state.page === 0 && (React.createElement(React.Fragment, null,
                    React.createElement("h1", null, "Components demo"),
                    React.createElement("button", { onClick: function () { return store_1.store.resetState(); } }, "Reset store"),
                    React.createElement(complex_1.Complex, null),
                    React.createElement(counter_1.Counter, null),
                    React.createElement(counter_events_1.CounterEvents, null),
                    React.createElement(counter_decorator_1.CounterDecorator, null))),
                pageStore.state.page === 1 && (React.createElement(React.Fragment, null,
                    React.createElement("h1", null, "Persistent store demo"),
                    React.createElement("button", { onClick: function () { return store_1.storePersistent.resetPersistence(); } }, "Reset persistence"),
                    React.createElement("button", { onClick: function () { return store_1.storePersistent.resetState(); } }, "Reset store"),
                    React.createElement(persistent_1.Persistent, null))),
                pageStore.state.page === 2 && (React.createElement(React.Fragment, null,
                    React.createElement("h1", null, "Snapshots demo"),
                    React.createElement("button", { onClick: function () { return store_1.storeHistory.resetPersistence(); } }, "Reset persistence"),
                    React.createElement("button", { onClick: function () { return store_1.storeHistory.resetState(); } }, "Reset store"),
                    React.createElement("button", { onClick: function () { return store_1.storeHistory.resetDumpHistory(); } }, "Reset history"),
                    React.createElement("button", { onClick: function () { return store_1.storeHistory.saveDump(); } }, "Save dump"),
                    React.createElement(history_1.History, null))))));
    };
    Container.prototype.handleClick = function (id, e) {
        e.preventDefault();
        pageStore.setState({
            page: id,
        });
...
ReactDOM.render(React.createElement(React.Fragment, null,
    React.createElement(container_1.Container, null)), document.getElementById('app'));
...
var Complex = /** @class */ (function (_super) {
    ...
    Complex.prototype.plusOne = function () {
        this.setState({
    ...
    Complex.prototype.render = function () {
        return (React.createElement("div", { className: "component" },
            ...
            React.createElement("p", null,
                "Local state counter: ",
                React.createElement("strong", null, this.state.counter.toString())),
            React.createElement("p", null,
                "Shared state counter: ",
                React.createElement("strong", null, store_2.store.state.counter.toString())),
            React.createElement("p", null,
                "Foo state is: ",
                React.createElement("strong", null, store_2.store.state.foo)),
            React.createElement("button", { onClick: this.plusOne.bind(this) }, "Local +1"),
            React.createElement("button", { onClick: function () {
                    store_2.store.setState({
                        counter: store_2.store.state.counter + 1,
                    });
                } }, "Store +1"),
            React.createElement("button", { onClick: function () {
                    store_2.store.setState({
                        foo: store_2.store.state.foo === 'foo' ? 'bar' : 'foo',
                    });
                } }, "Store foobar toggle")));
    };
    Complex = __decorate([
        store_1.followStore(store_2.store)
    ], Complex);
    return Complex;
}(React.Component));
...
var store_1 = __webpack_require__(3);
var store_2 = __webpack_require__(2);
var CounterDecorator = /** @class */ (function (_super) {
    __extends(CounterDecorator, _super);
    function CounterDecorator() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CounterDecorator.prototype.render = function () {
        return (React.createElement("div", { className: "component" },
...
var React = __webpack_require__(0);
var store_1 = __webpack_require__(2);
var CounterEvents = /** @class */ (function (_super) {
    __extends(CounterEvents, _super);
    ...
    CounterEvents.prototype.componentDidMount = function () {
        var _this = this;
        this.event = store_1.store.on('all', function (storeState) {
            _this.setState({
                commonStoreState: storeState
            });
        });
    };
    CounterEvents.prototype.componentWillUnmount = function () {
        this.event.remove();
    };
    CounterEvents.prototype.render = function () {
        if (this.state.commonStoreState) {
            return (React.createElement("div", { className: "component" },
                React.createElement("h2", null, "Linked component with event driven states"),
                React.createElement("p", null,
                    "Shared state counter: ",
                    React.createElement("strong", null, this.state.commonStoreState.counter.toString())),
                React.createElement("p", null,
                    "Foo state is: ",
                    React.createElement("strong", null, this.state.commonStoreState.foo)),
                React.createElement("button", { onClick: function () {
                        store_1.store.setState({
                            counter: store_1.store.state.counter + 1,
                        });
                    } }, "Store +1")));
        }
        else {
...
var Counter = /** @class */ (function (_super) {
    ...
    function Counter(props) {
        return _super.call(this, props, {
            common: store_2.store,
        }) || this;
    }
    Counter.prototype.render = function () {
        return (React.createElement("div", { className: "component" },
            React.createElement("h2", null, "Linked comonent"),
            React.createElement("p", null,
                "Shared state counter: ",
                React.createElement("strong", null, this.stores.common.state.counter.toString())),
            React.createElement("p", null,
                "Foo state is: ",
...
var History = /** @class */ (function (_super) {
    ...
    History.prototype.componentDidMount = function () {
        var _this = this;
        this.event = store_1.storeHistory.on('all', function (storeState) {
            _this.setState({
                commonStoreState: storeState
            });
        });
        this.event = store_1.storeHistory.on('dumpUpdate', function (storeState) {
            _this.setState({
                dumpHistory: store_1.storeHistory.getDumpHistory(),
            });
        });
    };
    ...
    History.prototype.restore = function (id, e) {
        e.preventDefault();
        store_1.storeHistory.restoreDump(id);
    };
    History.prototype.delete = function (id, e) {
        e.preventDefault();
        store_1.storeHistory.removeDump(id);
    };
    History.prototype.render = function () {
        var _this = this;
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "component" },
                React.createElement("h2", null, "History component"),
                React.createElement("p", null,
                    "Local state counter: ",
                    React.createElement("strong", null, this.state.counter.toString())),
                React.createElement("p", null,
                    "Shared state counter: ",
                    React.createElement("strong", null, store_1.storeHistory.state.counter.toString())),
                React.createElement("p", null,
                    "Foo state is: ",
                    React.createElement("strong", null, store_1.storeHistory.state.foo)),
                React.createElement("button", { onClick: function () {
                        _this.setState({
                ...
                React.createElement("button", { onClick: function () {
                        store_1.storeHistory.setState({
                            counter: store_1.storeHistory.state.counter + 1,
                        });
                    } }, "Store +1"),
                React.createElement("button", { onClick: function () {
                        store_1.storeHistory.setState({
                            foo: store_1.storeHistory.state.foo === 'foo' ? 'bar' : 'foo',
                        });
                    } }, "Store foobar toggle")),
            React.createElement("div", { className: "component" },
                React.createElement("h2", null, "Dump history"),
                this.state.dumpHistory.length > 0 ? (React.createElement("div", { className: "history" },
                    React.createElement("div", { className: "header" },
                        React.createElement("div", { className: "col" }, "ID"),
                        React.createElement("div", { className: "col" }, "Date")),
                    this.state.dumpHistory.map(function (item, i) {
                        return (React.createElement("div", { className: "row", key: i },
                            React.createElement("div", { className: "col", style: { width: "20%" } }, item.toString()),
                            React.createElement("div", { className: "col", style: { width: "70%" } }, new Date(item).toLocaleString()),
                            React.createElement("div", { className: "col", style: { width: "5%" } },
                                React.createElement("a", { className: "restore", href: "#", onClick: _this.restore.bind(_this, item) }, "Restore")),
                            React.createElement("div", { className: "col", style: { width: "5%" } },
                                React.createElement("a", { className: "delete", href: "#", onClick: _this.delete.bind(_this, item) }, "Delete"))));
                    }))) : (React.createElement("div", { className: "empty" }, "History is empty")))));
    };
    return History;
}(React.Component));
...
var Persistent = /** @class */ (function (_super) {
    ...
    Persistent.prototype.plusOne = function () {
        this.setState({
            counter: this.state.counter + 1,
        });
    };
    Persistent.prototype.render = function () {
        return (React.createElement("div", { className: "component" },
            React.createElement("h2", null, "Persistent store component"),
            React.createElement("p", null,
                "Local state counter: ",
                React.createElement("strong", null, this.state.counter.toString())),
            React.createElement("p", null,
                "Shared persistent counter: ",
                React.createElement("strong", null, store_2.storePersistent.state.counter.toString())),
            React.createElement("p", null,
                "Shared persistent foo: ",
                React.createElement("strong", null, store_2.storePersistent.state.foo)),
            React.createElement("button", { onClick: this.plusOne.bind(this) }, "Local +1"),
            React.createElement("button", { onClick: function () {
                    store_2.storePersistent.setState({
                        counter: store_2.storePersistent.state.counter + 1,
                    });
                } }, "Store +1"),
            React.createElement("button", { onClick: function () {
                    store_2.storePersistent.setState({
                        foo: store_2.storePersistent.state.foo === 'foo' ? 'bar' : 'foo',
                    });
                } }, "Store foobar toggle")));
    };
    Persistent = __decorate([
        store_1.followStore(store_2.storePersistent)
    ], Persistent);
    return Persistent;
}(React.Component));
...
var Freezer = __webpack_require__(32);
...
var Utils = __webpack_require__( 7 ),
	nodeCreator = __webpack_require__( 34),
	Emitter = __webpack_require__(14)
;
...
*/
var aa=__webpack_require__(6),ba=__webpack_require__(0),m=__webpack_require__(9),p=__webpack_require__(8),v=__webpack_require__(4),da=__webpack_require__(11),ea=__webpack_require__(12),fa=__webpack_require__(10),ha=__webpack_require__(5);

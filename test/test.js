...
var _formatReactElementNode = __webpack_require__(49);
...
var _objectInspect = __webpack_require__(90);
...
(function (CommonStore) {
    ...
    CommonStore.initialState = Object.freeze({
        nullObj: null,
        counter: 0,
        foo: 'foo',
        numericArray: [1, 2, 3],
    ...
    CommonStore.store = new store_1.Store(CommonStore.initialState, {
        live: true,
    }, new store_1.StorePersistantLocalSrorageDriver('comon'));
...
var _tmatch = __webpack_require__(99);
...
var _defineProperties = __webpack_require__(44);
...
var _isRegex = __webpack_require__(33);
...
var _objectKeys = __webpack_require__(35);
...
var expect_jsx_1 = __webpack_require__(45);
var store_1 = __webpack_require__(19);
var actions_1 = __webpack_require__(39);
...
describe('testStoreState', function () {
    ...
    it('event driven', function (done) {
        store_1.CommonStore.store.resetState();
        var counter = null;
        var event = store_1.CommonStore.store.on('update', function (storeState, prevState, type) {
    ...
    it('previous state', function (done) {
        store_1.CommonStore.store.resetState();
        var prev = '0';
        var event = store_1.CommonStore.store.on('update', function (storeState, prevState, type) {
    ...
    it('update event trigger', function (done) {
        store_1.CommonStore.store.resetState();
        var eventType = null;
        var event = store_1.CommonStore.store.on('update', function (storeState, prevState, type) {
            eventType = type;
    ...
    it('init event trigger', function (done) {
        store_1.CommonStore.store.resetState();
        var eventType = null;
        var event = store_1.CommonStore.store.on('init', function (storeState, prevState, type) {
            eventType = type;
        });
        expect(eventType).toEqual('init');
        done();
    });
    it('all event trigger', function (done) {
        store_1.CommonStore.store.resetState();
        var eventCount = 0;
        var event = store_1.CommonStore.store.on('all', function (storeState, prevState, type) {
            eventCount++;
        });
        store_1.CommonStore.store.setState({
            counter: 100,
    ...
    it('unnecessary updates', function (done) {
        store_1.CommonStore.store.resetState();
        var eventCount = 0;
        var event = store_1.CommonStore.store.on('all', function (storeState, prevState, type) {
            eventCount++;
    ...
    it('deep objects mutation', function (done) {
        store_1.CommonStore.store.resetState();
        var newObjArr = store_1.CommonStore.store.state.objectsArray.concat();
        newObjArr[0] = {
            test: 1,
        };
        store_1.CommonStore.store.setState({
        ...
        expect(JSON.stringify(store_1.CommonStore.store.state.objectsArray[0])).toEqual('{"test":1}');
        done();
    });
    it('deep objects direct assign throws', function (done) {
        store_1.CommonStore.store.resetState();
        var newObjArr = store_1.CommonStore.store.state.objectsArray;
        expect(function () {
            newObjArr[0] = {
                test: 1,
            };
    ...
    it('deep objects instance mutations', function (done) {
        store_1.CommonStore.store.resetState();
        var newObjArr1 = store_1.CommonStore.store.state.objectsArray.concat();
        var TheClass = function (a) {
            this.a = a;
        ...
        expect(store_1.CommonStore.store.state.objectsArray[0]['a']).toEqual(1);
        var newObjArr2 = store_1.CommonStore.store.state.objectsArray.concat();
        newObjArr2[0]['a'] = 2;
        store_1.CommonStore.store.setState({
            objectsArray: newObjArr2,
        });
        expect(store_1.CommonStore.store.state.objectsArray[0]['a']).toEqual(2);
        var newObjArr3 = store_1.CommonStore.store.state.objectsArray.concat();
        newObjArr3[0]['setA'](3);
        store_1.CommonStore.store.setState({
            objectsArray: newObjArr3,
        });
        expect(store_1.CommonStore.store.state.objectsArray[0]['a']).toEqual(3);
        done();
    });
});
...
Object.defineProperty(exports, "__esModule", { value: true });
var store_1 = __webpack_require__(19);
var CommonActions = /** @class */ (function () {
    function CommonActions() {
    }
    CommonActions.increaseCounter = function () {
        store_1.CommonStore.store.setState({
            counter: store_1.CommonStore.store.state.counter + 1
        });
    };
    CommonActions.toggleFooBar = function () {
        var newState = {
...
var Freezer = __webpack_require__(68);
...
var StorePersistantLocalSrorageDriver = /** @class */ (function (_super) {
    __extends(StorePersistantLocalSrorageDriver, _super);
    function StorePersistantLocalSrorageDriver(name, lifetime) {
        if (lifetime === void 0) { lifetime = Infinity; }
    ...
    StorePersistantLocalSrorageDriver.prototype.write = function (pack) {
        if (this.storage) {
            try {
    ...
    StorePersistantLocalSrorageDriver.prototype.read = function () {
        if (this.storage) {
            var dump = null;
            try {
    ...
    return StorePersistantLocalSrorageDriver;
}(StorePersistantDriver));
exports.StorePersistantLocalSrorageDriver = StorePersistantLocalSrorageDriver;
...
var _reactElementToJsxString = __webpack_require__(53);
...
var _sortobject = __webpack_require__(97);

var _sortobject2 = _interopRequireDefault(_sortobject);

var _parseReactElement = __webpack_require__(14);

var _parseReactElement2 = _interopRequireDefault(_parseReactElement);

var _formatTreeNode = __webpack_require__(7);
...
var _formatPropValue = __webpack_require__(48);
...
var _formatComplexDataStructure = __webpack_require__(46);
...
var _formatTree = __webpack_require__(50);
...
var Freezer = __webpack_require__(69);
...
var Utils = __webpack_require__( 12 ),
	nodeCreator = __webpack_require__( 71),
	Emitter = __webpack_require__(31)
;
...
var has = __webpack_require__(18);
var isArrowFunction = __webpack_require__(76);
var isBoolean = __webpack_require__(77);
var isDate = __webpack_require__(78);
var isGenerator = __webpack_require__(82);
var isNumber = __webpack_require__(83);
var isRegex = __webpack_require__(33);
...
var collectionsForEach = __webpack_require__(79)();
...
var inspectCustom = __webpack_require__(101).custom;
...
var m=__webpack_require__(4),n=__webpack_require__(11),p=__webpack_require__(6),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
const isRegexp = __webpack_require__(86);
const isObj = __webpack_require__(84);
const getOwnEnumPropSymbols = __webpack_require__(74);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0), __webpack_require__(42).Buffer))

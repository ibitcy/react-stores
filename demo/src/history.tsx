...
export class History extends React.Component<Props, State> {
	...
	componentDidMount() {
		this.event = storeHistory.on('all', (storeState: StoreState) => {
			this.setState({
				commonStoreState: storeState
			});
		});

		this.event = storeHistory.on('dumpUpdate', (storeState: StoreState) => {
			this.setState({
		...
		return (
			<>
				<div className="component">
					...
					<p>Shared state counter: <strong>{storeHistory.state.counter.toString()}</strong></p>
								...
								return (
									<div className="row" key={i}>
										...
										<div className="col" style={{width: "5%"}}>
											<a className="restore" href="#" onClick={this.restore.bind(this, item)}>Restore</a>
										</div>

										<div className="col" style={{width: "5%"}}>
											<a className="delete" href="#" onClick={this.delete.bind(this, item)}>Delete</a>
										</div>
									</div>
								);
							})}

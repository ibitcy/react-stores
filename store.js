...
var Store = /** @class */ (function () {
    function Store(initialState, options, persistenceDriver) {
        ...
        this.name = this.generateStoreName(initialState);
        if (options) {
        ...
        if (!this.persistenceDriver) {
            this.persistenceDriver = new StorePersistentLocalSrorageDriver(this.name);
        }
    ...
    Store.prototype.generateStoreName = function (state) {
        var stateName = Object.keys(state).join(':');
